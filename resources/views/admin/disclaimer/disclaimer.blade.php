            ...
            <div class="container-fluid">
                <div class="row">
                    <section class="col-lg-12">
                        <div class="container">
                            <h1>disclaimer</h1>
                            <a href="{{ route('add-pp-page-disclaimer') }}" class="btn btn-primary mb-2">Add disclaimer policy</a>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <a href="{{ route('edit-pp-page-disclaimer', $pp->id) }}" class="btn btn-warning">Edit</a>


                                                <!-- Button to trigger modal -->
                                                {{-- <a href="#" class="btn btn-success" data-toggle="modal" data-target="#addPointsModal" data-customer-id="{{ $tnc->id }}">Add Points</a> --}}

                                                <form action="{{ route('delete-pp-disclaimer', $pp->id) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
