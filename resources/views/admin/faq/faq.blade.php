            ...
            <div class="container-fluid">
                <div class="row">
                    <section class="col-lg-12">
                        <div class="container">
                            <h1>FAQ</h1>
                            <a href="{{ route('add-faq-page-admin') }}" class="btn btn-primary mb-2">Add FAQ</a>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-faq-page-admin', $customer->id) }}" class="btn btn-warning">Edit</a>

                                                <!-- Button to trigger modal -->
                                                {{-- <a href="#" class="btn btn-success" data-toggle="modal" data-target="#addPointsModal" data-customer-id="{{ $customer->id }}">Add Points</a> --}}

                                                <form action="{{ route('delete-faq-admin', $customer->id) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
