...
<head>
    ...
    <link rel="stylesheet"
        href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.14.0/themes/black-tie/jquery-ui.min.css">
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ config('app.url') }}/Theme/dist/img/user1-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ config('app.url') }}/Theme/dist/img/user8-128x128.jpg" alt="User Avatar"
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="{{ config('app.url') }}/Theme/dist/img/user3-128x128.jpg" alt="User Avatar"
                                    class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Alero Admin</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('BuyerDataShow') }}" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Buyer Data Edit</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('SellerDataShow') }}" class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Seller data Edit</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('packages.index') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i> <!-- You can change the icon here -->
                                <p>Package</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('assign-package') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i> <!-- You can change the icon here -->
                                <p>Assign package</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('view-assign-package') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i> <!-- You can change the icon here -->
                                <p>View assign package</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/admin/notifications/create') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i> <!-- You can change the icon here -->
                                <p>Create Notification</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('/admin/notifications/show') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i> <!-- You can change the icon here -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('faq-admin') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i>
                                <p>Faq</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('pp-admin') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i>
                                <p>Privacy Policy</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('tnc-admin') }}" class="nav-link">
                                <i class="nav-icon fas fa-box"></i>
