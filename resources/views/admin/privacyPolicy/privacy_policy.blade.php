                ...
                <div class="row">
                    <section class="col-lg-12">
                        <div class="container">
                            ...
                            <a href="{{ route('add-pp-page-admin') }}" class="btn btn-primary mb-2">Add Privacy Policy</a>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-pp-page-admin', $pp->id) }}" class="btn btn-warning">Edit</a>

                                                <!-- Button to trigger modal -->
                                                {{-- <a href="#" class="btn btn-success" data-toggle="modal" data-target="#addPointsModal" data-customer-id="{{ $tnc->id }}">Add Points</a> --}}

                                                <form action="{{ route('delete-pp-admin', $pp->id) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
