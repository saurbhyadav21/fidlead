                ...
                <div class="row">
                    <section class="col-lg-12">
                        <div class="container">
                            ...
                            <a href="{{ route('add-tnc-page-admin') }}" class="btn btn-primary">Add Terms & Conditions</a>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $tnc->created_at }}</td>

                                            <td>
                                                <a href="{{ route('edit-tnc-page-admin', $tnc->id) }}" class="btn btn-warning">Edit</a>

                                                <!-- Button to trigger modal -->
                                                {{-- <a href="#" class="btn btn-success" data-toggle="modal" data-target="#addPointsModal" data-customer-id="{{ $tnc->id }}">Add Points</a> --}}

                                                <form action="{{ route('delete-tnc-admin', $tnc->id) }}" method="POST" style="display:inline-block;">
                                                    @csrf
                                                    @method('DELETE')
