...
<body>
    ...
    <div class="footer">
        <p>&copy; 2024 My Website. All rights reserved. | <a href="{{ route('privacy-policy-website') }}" style="color: #f1f1f1">Privacy Policy</a> | <a href="#" style="color: #f1f1f1">Contact Us| <a href="{{ route('tnc-website') }}" style="color: #f1f1f1">Terms and Condition</a></p>
    </div>
</body>
{{-- <script> --}}
