...
// faq admin side
    ...
    Route::get('/faq-admin', [FAQController::class, 'faqAdmin'])->name('faq-admin');
    Route::get('/add-faq-page-admin', [FAQController::class, 'addFaqPage'])->name('add-faq-page-admin');
    Route::post('/create-faq-admin', [FAQController::class, 'create'])->name('create-faq-admin');
    Route::get('/edit-faq-page-admin', [FAQController::class, 'editPage'])->name('edit-faq-page-admin');
    Route::put('/edit-faq-admin/{id}', [FAQController::class, 'update'])->name('edit-faq-admin');
    Route::delete('/delete-faq-admin/{id}', [FAQController::class, 'destroy'])->name('delete-faq-admin');
    
//tnc admin side

    Route::get('/tnc-admin', [Controller::class, 'tncIndex'])->name('tnc-admin');
    Route::get('/add-tnc-page-admin', [Controller::class, 'addTncPage'])->name('add-tnc-page-admin');
    Route::post('/create-tnc-admin', [Controller::class, 'create'])->name('create-tnc-admin');
    Route::get('/edit-tnc-page-admin', [Controller::class, 'editPage'])->name('edit-tnc-page-admin');
    Route::put('/edit-tnc-admin/{id}', [Controller::class, 'update'])->name('edit-tnc-admin');
    Route::delete('/delete-tnc-admin/{id}', [Controller::class, 'destroy'])->name('delete-tnc-admin');

    //privacy policy
    Route::get('/pp-admin', [Controller::class, 'ppIndex'])->name('pp-admin');
    Route::get('/add-pp-page-admin', [Controller::class, 'addppPage'])->name('add-pp-page-admin');
    Route::post('/create-pp-admin', [Controller::class, 'createpp'])->name('create-pp-admin');
    Route::get('/edit-pp-page-admin', [Controller::class, 'editppPage'])->name('edit-pp-page-admin');
    Route::put('/edit-pp-admin/{id}', [Controller::class, 'updatePp'])->name('edit-pp-admin');
    Route::delete('/delete-pp-admin/{id}', [Controller::class, 'destroyPp'])->name('delete-pp-admin');


        //refund
    Route::get('/pp-refund', [Controller::class, 'refundIndex'])->name('pp-refund');
    Route::get('/add-pp-page-refund', [Controller::class, 'addrefundPage'])->name('add-pp-page-refund');
    Route::post('/create-pp-refund', [Controller::class, 'createrefund'])->name('create-pp-refund');
    Route::get('/edit-pp-page-refund/{id}', [Controller::class, 'editrefundPage'])->name('edit-pp-page-refund');
    Route::put('/edit-pp-refund/{id}', [Controller::class, 'updaterefund'])->name('edit-pp-refund');
    Route::delete('/delete-pp-refund/{id}', [Controller::class, 'destroyrefund'])->name('delete-pp-refund');


     //disclaimer
    Route::get('/pp-disclaimer', [Controller::class, 'disclaimerIndex'])->name('pp-disclaimer');
    Route::get('/add-pp-page-disclaimer', [Controller::class, 'adddisclaimerPage'])->name('add-pp-page-disclaimer');
    Route::post('/create-pp-disclaimer', [Controller::class, 'createdisclaimer'])->name('create-pp-disclaimer');
    Route::get('/edit-pp-page-disclaimer/{id}', [Controller::class, 'editdisclaimerPage'])->name('edit-pp-page-disclaimer');
    Route::put('/edit-pp-disclaimer/{id}', [Controller::class, 'updatedisclaimer'])->name('edit-pp-disclaimer');
    Route::delete('/delete-pp-disclaimer/{id}', [Controller::class, 'destroydisclaimer'])->name('delete-pp-disclaimer');
...
Route::get('/tnc-website', function () {
    ...
    return view('tnc',compact('tnc'));
})->name('tnc-website');



//Refund and disclamer
    Route::get('/refund', function () {
        $refund=DB::table('refund')->first();
